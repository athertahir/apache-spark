...
object ratingsByMovies {
  ...
  def loadMovieNames(): Map[Int, String] = {
    ...
    val data = Source.fromFile("/home/scrapbook/tutorial/apache-spark/Files/chapter_6/movies.csv").getLines()
  ...
  def main(args: Array[String]): Unit = {
    ...
    val data = sc.textFile("/home/scrapbook/tutorial/apache-spark/Files/chapter_6/ratings.csv")
